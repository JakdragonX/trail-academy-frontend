...
export default function LoadingState({ currentTask }: LoadingStateProps) {
  const tasks = [
  ...
  return (
    <div className="min-h-[400px] flex flex-col items-center justify-center p-8">
      <div className="w-full max-w-md space-y-8">
        <h2 className="text-2xl font-bold text-center mb-8 text-[#2D4F1E]">Generating Your Course</h2>
              ...
              >
                <div className={`
                  ...
                  ${isCompleted ? 'bg-green-100 text-green-600' : 
                    isCurrentTask ? 'bg-[#2D4F1E]/10 text-[#2D4F1E]' : 
        ...
        <div className="mt-8 text-center text-[#2D4F1E]/70">
